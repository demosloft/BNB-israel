...
set_time_limit(1800000); //set the execution time to 3 minutes, in case it takes longer to get results.
...
class rentalsUnited {  
    ...
    private $username = 'jonathan@bnbisrael.com'; //Your username provided by Rentals United
    private $password = '8o6LhQ5ryJMBjYP6K%9ibpTKnLxRJgNhXKKdPNz*'; //Your password provided by Rentals United
    ...
    */
    function getPropertiesList($loc_code=''){
        $post[] = "<Pull_ListProp_RQ>
                  ...
                  </Pull_ListProp_RQ>";//<LocationID>$loc_code</LocationID>
        $x = $this->curlPushBack($this->server_url,$post);
        return simplexml_load_string($x['messages']);
    }
    ...
    */         
    ...
    function curlPushBack($url, $post_fields = "", $head = 0, $follow = true, $header="", $referer="", $is_ssl = false, $debug = 0){

        $ch = curl_init ();

        $header[0]="Accept: text/xml,application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,*/*;q=0.5";
        $header[1]="Accept-Language: en-us";
        $header[2]="Accept-Charset: SO-8859-1,utf-8;q=0.7,*;q=0.7";
        $header[3]="Keep-Alive: 30000000";
